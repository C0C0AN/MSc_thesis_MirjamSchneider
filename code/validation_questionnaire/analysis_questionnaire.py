...
# for loop to use function for all files in one directory
# path = '/home/klara/Dokumente/7/Bachelorarbeit/Fragebogen/Ergebnisse/'
# import os
# for filename in os.listdir(path):
#    analysis_questionnaire(path + filename)
...
def analysis_questionnaire(json_file):
    ...
    # q_json=json.load(open('beispiel_ergebnisstring_sortables1.json'))
    ...
    q_data = pd.DataFrame(columns=['id', 'age', 'sex', 'handedness', 'education', 'job', 'hearing', 'hearing_dis',
                                 ...
                                 'trance_sortable', 'trance_sortable_sure', 'trance_know', 'electro_all'], index=[list(range(0,23))])
    ...
    # ab hier items anpassen: nicht englisch, sondern das was bei q_json jeweils drunter steht
    ...
    return q_data
    f.close()
    # sortables: top stimulus is most representative
