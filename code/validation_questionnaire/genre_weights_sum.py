...
# read in data frame and check columns
df = pd.read_csv('/home/mirjam/Desktop/Masterarbeit/Fragebögen_und_Validierung/Auswertung/full_dataset.csv')
print(df.columns)

# define a list of all sortables which is later on used to create sub data frames
